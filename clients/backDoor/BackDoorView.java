...
public class BackDoorView implements Observer
{
  ...
  public BackDoorView(  RootPaneContainer rpc, MiddleFactory mf, int x, int y )
  {
    ...
    theBtQuery.addActionListener(new SoundButton("minecraft_click.wav"));
    ...
    theBtRStock.addActionListener(new SoundButton("vine.wav"));
    theBtRStock.setBackground(Color.yellow);           //  color change
    ...
    theBtClear.addActionListener(new SoundButton("minecraft_click.wav"));
